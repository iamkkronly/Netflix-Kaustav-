...
export default function Homepage() {
  ...
  return (
    ...
    <div className="min-h-screen text-white p-4 md:p-12 relative bg-black"> 
      ...
      <header className="sticky top-0 z-40 bg-black/95 backdrop-blur-sm shadow-xl mb-8 border-b border-gray-900 pt-4 pb-6 px-4 md:px-0 -mx-4 md:-mx-12">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center w-full max-w-7xl mx-auto">
          ...
          <form onSubmit={handleSearch} className="flex gap-3 w-full md:max-w-md">
            <input
              ...
              // Enhanced input styling - bg-gray-800 on black background
      ...
      <main className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-3 md:gap-4">
          {movies.map((movie, index) => (
            <div
              key={movie._id}
              // 🔥 ADJUSTED: Card color set to bg-gray-900 for dark card on black background
              className={`bg-gray-900 p-3 rounded-2xl shadow-xl shadow-black/50
                         flex flex-col items-center relative group overflow-hidden border border-gray-800
                         transform transition-all duration-500 ease-out 
                         hover:scale-[1.05] hover:shadow-green-900/80 hover:bg-gray-800 hover:z-10`}
